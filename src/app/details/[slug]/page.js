...
const id = slug?.split('_').pop();
  ...
  const shareOnPinterest = () => {
    const mediaUrl = "https://iconsguru.ascinatetech.com/admin/storage/temp_icons/d0503d20-1e50-4445-9f72-3452124b82a1.png";
    const description = `Check out this icon from IconsGuru!`;
