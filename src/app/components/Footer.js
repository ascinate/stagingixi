                    ...
                    <div className="col">
                        <div className="comon-footers-div01">
                            ...
                            <ul className="solic-list d-flex align-items-center">
                                <li>
                                    <Link href='https://www.instagram.com/iconguru_official/' className="ft-scol">
                                ...
                                <li>
                                    <Link href='https://www.facebook.com/profile.php?id=61575078242862' className="ft-scol">
                                ...
                                <li>
                                   <Link href='https://x.com/icons_guru' className="ft-scol">
                                ...
                                <li>
                                    <Link href='https://www.linkedin.com/in/icons-guru-27583335b/' className="ft-scol">
